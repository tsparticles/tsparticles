...
Siga las indicaciones interactivas para elegir una plantilla y un framework.
Se creará un nuevo proyecto con tsParticles preconfigurado en el directorio actual.
