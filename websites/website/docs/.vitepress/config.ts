  ...
  "/options/": [
    ...
    },
    {
      ...
      items: [
        ...
        { text: "Plugin: Background Mask", link: "/options/plugin-background-mask" },
        { text: "Plugin: Blend", link: "/options/plugin-blend" },
        { text: "Plugin: Canvas Mask", link: "/options/plugin-canvas-mask" },
        { text: "Plugin: Colors", link: "/options/plugin-colors" },
        { text: "Plugin: Easings", link: "/options/plugin-easings" },
        { text: "Plugin: Effects", link: "/options/plugin-effects" },
        { text: "Plugin: Emitter Shapes", link: "/options/plugin-emitter-shapes" },
        { text: "Plugin: Emitters", link: "/options/plugin-emitters" },
        { text: "Plugin: Exports", link: "/options/plugin-exports" },
        { text: "Plugin: Infection", link: "/options/plugin-infection" },
        { text: "Plugin: Interactions", link: "/options/plugin-interactions" },
        { text: "Plugin: Motion", link: "/options/plugin-motion" },
        { text: "Plugin: Path Generators", link: "/options/plugin-path-generators" },
        { text: "Plugin: Poisson", link: "/options/plugin-poisson" },
        { text: "Plugin: Polygon Mask", link: "/options/plugin-polygon-mask" },
        { text: "Plugin: Responsive", link: "/options/plugin-responsive" },
        { text: "Plugin: Shapes", link: "/options/plugin-shapes" },
        { text: "Plugin: Sounds", link: "/options/plugin-sounds" },
        { text: "Plugin: Themes", link: "/options/plugin-themes" },
        { text: "Plugin: Trail", link: "/options/plugin-trail" },
        { text: "Plugin: Updaters", link: "/options/plugin-updaters" },
        { text: "Plugin: Zoom", link: "/options/plugin-zoom" },
      ],
    },
  ],
  "/migrations/": [
