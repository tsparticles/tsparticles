# Plugin Option: Easings

`easings` provides easing functions used by particle animations. These are selected via the `easing` property in animation options.
...
- Easing plugins do not expose a top-level options object.
- Select them via animation `easing` properties (e.g. `speed.animation.easing`).

## Source reference

- <https://github.com/tsparticles/tsparticles/blob/main/markdown/Options/Plugins/Easings.md>
