...
const minBanner = `tsParticles Fireworks Preset v${version} by Matteo Bruni`;

module.exports = [
    getConfig(getEntry("fireworks", false), banner, minBanner, __dirname, false),
    getConfig(getEntry("fireworks.bundle", true), banner, minBanner, __dirname, true)
];
