...
![demo](https://raw.githubusercontent.com/matteobruni/tsparticles/main/presets/fireworks/images/sample.png)
...
```html
<script src="https://cdn.jsdelivr.net/npm/tsparticles-preset-fireworks/dist/tsparticles.preset.fireworks.bundle.min.js"></script>
```
