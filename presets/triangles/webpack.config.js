...
const minBanner = `tsParticles Triangles Preset v${version} by Matteo Bruni`;

module.exports = [
    getConfig(getEntry("triangles", false), banner, minBanner, __dirname, false),
    getConfig(getEntry("triangles.bundle", true), banner, minBanner, __dirname, true)
];
