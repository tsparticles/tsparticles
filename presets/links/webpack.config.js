...
const getEntry = (name, bundle) => {
    ...
    obj[`tsparticles.preset.${name}`] = `./dist/esm/${fileName}.js`;
    obj[`tsparticles.preset.${name}.min`] = `./dist/esm/${fileName}.js`;
...
module.exports = [
    getConfig(getEntry("links", false), banner, minBanner, __dirname, false),
    getConfig(getEntry("links.bundle", true), banner, minBanner, __dirname, true)
];
