...
**File:** `bundles/ribbons/src/ribbons.ts` ~line 132, `bundles/ribbons/src/ribbons.lazy.ts` ~line 141
...
**Fix:** Change `{}` to `options` (applied in both `ribbons.ts` and `ribbons.lazy.ts`):
