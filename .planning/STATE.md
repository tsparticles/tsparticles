...
14. ✅ **S14 Stencil** — done (`theme` prop + `particlesLoaded` event + `@Watch("theme")` + demo con theme toggle + `@tsparticles/plugin-themes` installato, build passa). ❏ **S15–S17** — align remaining extended wrappers (Ember, jQuery, Angular-fireworks)
