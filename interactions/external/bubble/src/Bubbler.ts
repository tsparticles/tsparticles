...
export class Bubbler extends ExternalInteractorBase<BubbleContainer> {
    ...
    private _hoverBubbleColor(particle: Particle, ratio: number, divBubble?: BubbleDiv): void {
        const options = this.container.actualOptions,
    ...
    private process(particle: Particle, distMouse: number, timeSpent: number, data: Interfaces): void {
        const container = this.container,
