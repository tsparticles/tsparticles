...
- Event mode key: `interactivity.events.onHover.mode` or `interactivity.events.onClick.mode` with value `"particle"`
- Mode options key: `interactivity.modes.particle`
