...
function getEntry(name) {
  ...
  obj[`tsparticles.interaction.${name}`] = "./dist/browser/index.js";
  obj[`tsparticles.interaction.${name}.min`] = "./dist/browser/index.js";
...
const minBanner = `tsParticles Light Interaction v${version} by Matteo Bruni`;

module.exports = [
  getConfig(getEntry("light"), banner, minBanner, __dirname)
];
