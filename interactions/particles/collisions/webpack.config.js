...
function getEntry(name) {
  ...
  obj[`tsparticles.interaction.particles.${name}`] = "./dist/index.js";
  obj[`tsparticles.interaction.particles.${name}.min`] = "./dist/index.js";
...
const minBanner = `tsParticles Template External Interaction v${version} by Matteo Bruni`;

module.exports = [
  getConfig(getEntry("collisions"), banner, minBanner, __dirname)
];
