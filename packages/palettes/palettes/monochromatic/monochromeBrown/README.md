...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMonochromeBrownPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-brown@4/tsparticles.palette-monochrome-brown.min.js"></script>
```
...
(async engine => {
  ...
  await loadMonochromeBrownPalette(engine);
