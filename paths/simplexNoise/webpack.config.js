...
const getEntry = (name) => {
    ...
    obj[`tsparticles.path.${name}`] = "./dist/browser/index.js";
    obj[`tsparticles.path.${name}.min`] = "./dist/browser/index.js";
...
const minBanner = `tsParticles Simplex Noise Path v${version} by Matteo Bruni`;

module.exports = [
    getConfig(getEntry("simplex.noise"), banner, minBanner, __dirname)
];
