...
fs.readFile("./projects/ng-confetti/package.dist.json", function (distError, distData) {
  if (distError) {
  ...
  fs.writeFile("./projects/ng-confetti/package.dist.json", JSON.stringify(distObj, undefined, 2), 'utf-8', function () {
