...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/desertSand/images/sample.png)](https://particles.js.org/samples/palettes/desert-sand)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-desert-sand@3/tsparticles.palette.desert-sand.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadDesertSandPalette(tsParticles);
