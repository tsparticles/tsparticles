...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/matrixRain/images/sample.png)](https://particles.js.org/samples/palettes/matrix-rain)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-matrix-rain@3/tsparticles.palette.matrix-rain.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMatrixRainPalette(tsParticles);
