...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/autumnLeaves/images/sample.png)](https://particles.js.org/samples/palettes/autumn-leaves)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-autumn-leaves@3/tsparticles.palette.autumn-leaves.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadAutumnLeavesPalette(tsParticles);
...
paautumnLeaves[Autumn Leaves]
end

e[tsParticles Engine] --> paautumnLeaves
```
