...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-bokeh-gold@4/tsparticles.palette-bokeh-gold.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadBokehGoldPalette(tsParticles);
