...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/risingBubbles/images/sample.png)](https://particles.js.org/samples/palettes/rising-bubbles)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-rising-bubbles@3/tsparticles.palette.rising-bubbles.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadRisingBubblesPalette(tsParticles);
