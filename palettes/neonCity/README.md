...
[tsParticles](https://github.com/tsparticles/tsparticles) palette for neon city.
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/neonCity/images/sample.png)](https://particles.js.org/samples/palettes/neon-city)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-neon-city@3/tsparticles.palette.neon-city.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadNeonCityPalette(tsParticles);
...
Checkout the documentation in the component library repository and call the `loadNeonCityPalette` function instead of `loadFull`, `loadSlim` or similar functions.
...
paneonCity[Neon City]
end

e[tsParticles Engine] --> paneonCity
```
