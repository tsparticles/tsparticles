...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/waterSplash/images/sample.png)](https://particles.js.org/samples/palettes/water-splash)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-water-splash@3/tsparticles.palette.water-splash.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadWaterSplashPalette(tsParticles);
