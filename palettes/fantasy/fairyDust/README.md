...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/fairyDust/images/sample.png)](https://particles.js.org/samples/palettes/fairy-dust)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fairy-dust@3/tsparticles.palette.fairy-dust.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFairyDustPalette(tsParticles);
