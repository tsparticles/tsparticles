...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/poisonAndVenom/images/sample.png)](https://particles.js.org/samples/palettes/poison-and-venom)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-poison-and-venom@3/tsparticles.palette.poison-and-venom.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadPoisonAndVenomPalette(tsParticles);
