...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/rain/images/sample.png)](https://particles.js.org/samples/palettes/rain)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-rain@3/tsparticles.palette.rain.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadRainPalette(tsParticles);
