...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/dandelionSeeds/images/sample.png)](https://particles.js.org/samples/palettes/dandelion-seeds)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-dandelion-seeds@4/tsparticles.palette.dandelion-seeds.min.js"></script>
```
...
- Calling `tsParticles.load(...)` before `loadDandelionSeedsPalette(...)`
