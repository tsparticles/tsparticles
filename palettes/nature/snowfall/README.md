...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/snowfall/images/sample.png)](https://particles.js.org/samples/palettes/snowfall)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-snowfall@4/tsparticles.palette.snowfall.min.js"></script>
```
...
- Calling `tsParticles.load(...)` before `loadSnowfallPalette(...)`
