...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/acidPair/images/sample.png)](https://particles.js.org/samples/palettes/acid-pair)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-acid-pair@4/tsparticles.palette.acid-pair.min.js"></script>
```
...
- Calling `tsParticles.load(...)` before `loadAcidPairPalette(...)`
