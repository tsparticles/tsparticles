...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/atmosphere/coloredSmokeRainbow/images/sample.png)](https://particles.js.org/samples/palettes/colored-smoke-rainbow)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-colored-smoke-rainbow@4/tsparticles.palette-colored-smoke-rainbow.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadColoredSmokeRainbowPalette(tsParticles);
