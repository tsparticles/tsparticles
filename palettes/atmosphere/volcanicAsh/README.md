...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-volcanic-ash@4/tsparticles.palette-volcanic-ash.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadVolcanicAshPalette(tsParticles);
