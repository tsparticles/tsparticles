...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/coloredSmokeMagenta/images/sample.png)](https://particles.js.org/samples/palettes/colored-smoke-magenta)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-colored-smoke-magenta@3/tsparticles.palette.colored-smoke-magenta.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadColoredSmokeMagentaPalette(tsParticles);
