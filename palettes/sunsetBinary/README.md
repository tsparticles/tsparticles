...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/sunsetBinary/images/sample.png)](https://particles.js.org/samples/palettes/sunset-binary)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-sunset-binary@3/tsparticles.palette.sunset-binary.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadSunsetBinaryPalette(tsParticles);
