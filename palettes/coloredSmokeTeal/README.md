...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/coloredSmokeTeal/images/sample.png)](https://particles.js.org/samples/palettes/colored-smoke-teal)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-colored-smoke-teal@3/tsparticles.palette.colored-smoke-teal.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadColoredSmokeTealPalette(tsParticles);
