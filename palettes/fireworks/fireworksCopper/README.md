...
2. Load a base package (for example `@tsparticles/basic`) and call `loadFireworksCopperPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-copper@4/tsparticles.palette-fireworks-copper.min.js"></script>
```
...
(async engine => {
  ...
  await loadFireworksCopperPalette(engine);
