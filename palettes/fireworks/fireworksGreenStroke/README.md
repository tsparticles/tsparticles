...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-green-stroke@4/tsparticles.palette-fireworks-green-stroke.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksGreenStrokePalette(tsParticles);

  await tsParticles.load({
    id: "tsparticles",
    options: { palette: "fireworks-green-stroke" },
  });
})();
```
