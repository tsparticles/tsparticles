...
2. Load a base package (for example `@tsparticles/basic`) and call `loadFireworksGoldPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-gold@4/tsparticles.palette.fireworks-gold.min.js"></script>
```
