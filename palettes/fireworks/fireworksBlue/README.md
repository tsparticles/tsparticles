...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-blue@4/tsparticles.palette-fireworks-blue.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksBluePalette(tsParticles);
