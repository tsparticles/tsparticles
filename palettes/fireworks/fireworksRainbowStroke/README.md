...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-rainbow-stroke@4/tsparticles.palette-fireworks-rainbow-stroke.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksRainbowStrokePalette(tsParticles);
