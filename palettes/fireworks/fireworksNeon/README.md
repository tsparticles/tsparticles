...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-neon@4/tsparticles.palette-fireworks-neon.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksNeonPalette(tsParticles);
