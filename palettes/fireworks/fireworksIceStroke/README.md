...
2. Load a base package (for example `@tsparticles/basic`) and call `loadFireworksIceStrokePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-ice-stroke@4/tsparticles.palette-fireworks-ice-stroke.min.js"></script>
```
...
(async engine => {
  ...
  await loadFireworksIceStrokePalette(engine);
