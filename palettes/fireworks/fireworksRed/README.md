...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-red@4/tsparticles.palette-fireworks-red.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksRedPalette(tsParticles);
