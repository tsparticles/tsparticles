...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-pastel-stroke@4/tsparticles.palette-fireworks-pastel-stroke.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadFireworksPastelStrokePalette(tsParticles);

  await tsParticles.load({
    id: "tsparticles",
    options: { palette: "fireworks-pastel-stroke" },
  });
})();
```
