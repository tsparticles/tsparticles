...
2. Load a base package (for example `@tsparticles/basic`) and call `loadFireworksMulticolorStrokePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-fireworks-multicolor-stroke@4/tsparticles.palette.fireworks-multicolor-stroke.min.js"></script>
```
...
(async engine => {
  ...
  await loadFireworksMulticolorStrokePalette(engine);
