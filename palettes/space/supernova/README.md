...
[tsParticles](https://github.com/tsparticles/tsparticles) palette for supernova.
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/supernova/images/sample.png)](https://particles.js.org/samples/palettes/supernova)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-supernova@3/tsparticles.palette.supernova.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadSupernovaPalette(tsParticles);
...
Checkout the documentation in the component library repository and call the `loadSupernovaPalette` function instead of `loadFull`, `loadSlim` or similar functions.

The options shown above are valid for all the component libraries.

## Common pitfalls

- Calling `tsParticles.load(...)` before `loadSupernovaPalette(...)`
...
pasupernova[Supernova]
end

e[tsParticles Engine] --> pasupernova
```
