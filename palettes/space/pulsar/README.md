...
[tsParticles](https://github.com/tsparticles/tsparticles) palette for pulsar.
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/pulsar/images/sample.png)](https://particles.js.org/samples/palettes/pulsar)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-pulsar@3/tsparticles.palette.pulsar.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadPulsarPalette(tsParticles);
...
Checkout the documentation in the component library repository and call the `loadPulsarPalette` function instead of `loadFull`, `loadSlim` or similar functions.
