...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/galaxyDust/images/sample.png)](https://particles.js.org/samples/palettes/galaxy-dust)
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-galaxy-dust@4/tsparticles.palette.galaxy-dust.min.js"></script>
```
...
pagalaxyDust[Galaxy Dust]
end

e[tsParticles Engine] --> pagalaxyDust
```
