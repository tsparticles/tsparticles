...
# tsParticles Solar Wind Palette
...
[tsParticles](https://github.com/tsparticles/tsparticles) palette for solar wind.
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/solarWind/images/sample.png)](https://particles.js.org/samples/palettes/solar-wind)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-solar-wind@3/tsparticles.palette.solar-wind.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadSolarWindPalette(tsParticles);
...
Checkout the documentation in the component library repository and call the `loadSolarWindPalette` function instead of `loadFull`, `loadSlim` or similar functions.

The options shown above are valid for all the component libraries.

## Common pitfalls

- Calling `tsParticles.load(...)` before `loadSolarWindPalette(...)`
...
pasolarWind[Solar Wind]
end

e[tsParticles Engine] --> pasolarWind
```
