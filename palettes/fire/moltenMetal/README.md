...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/moltenMetal/images/sample.png)](https://particles.js.org/samples/palettes/molten-metal)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-molten-metal@3/tsparticles.palette.molten-metal.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMoltenMetalPalette(tsParticles);
