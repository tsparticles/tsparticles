...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-confetti-neon@4/tsparticles.palette-confetti-neon.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadConfettiNeonPalette(tsParticles);
