...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-confetti-gold@4/tsparticles.palette-confetti-gold.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadConfettiGoldPalette(tsParticles);
