...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-confetti-rainbow@4/tsparticles.palette-confetti-rainbow.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadConfettiRainbowPalette(tsParticles);
