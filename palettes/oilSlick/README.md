...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/oilSlick/images/sample.png)](https://particles.js.org/samples/palettes/oil-slick)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-oil-slick@3/tsparticles.palette.oil-slick.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadOilSlickPalette(tsParticles);
