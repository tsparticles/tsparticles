...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-oranges@4/tsparticles.palette-monochrome-oranges.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMonochromeOrangesPalette(tsParticles);
