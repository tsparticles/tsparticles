...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-cyan@4/tsparticles.palette-monochrome-cyan.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMonochromeCyanPalette(tsParticles);
