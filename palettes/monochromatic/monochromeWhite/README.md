...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMonochromeWhitePalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-white@4/tsparticles.palette-monochrome-white.min.js"></script>
```
...
(async engine => {
  ...
  await loadMonochromeWhitePalette(engine);
