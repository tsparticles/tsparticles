...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/monochromeNoir/images/sample.png)](https://particles.js.org/samples/palettes/monochrome-noir)
...
2. Load a base package (for example `@tsparticles/basic`) and call `loadMonochromeNoirPalette` before `tsParticles.load(...)`
...
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-noir@4/tsparticles.palette.monochrome-noir.min.js"></script>
```
...
(async engine => {
  ...
  await loadMonochromeNoirPalette(engine);
