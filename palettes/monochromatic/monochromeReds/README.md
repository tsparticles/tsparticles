...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-monochrome-reds@4/tsparticles.palette-monochrome-reds.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMonochromeRedsPalette(tsParticles);
