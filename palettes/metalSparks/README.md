...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/metalSparks/images/sample.png)](https://particles.js.org/samples/palettes/metal-sparks)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-metal-sparks@3/tsparticles.palette.metal-sparks.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadMetalSparksPalette(tsParticles);
