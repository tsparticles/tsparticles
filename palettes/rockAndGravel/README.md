...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/rockAndGravel/images/sample.png)](https://particles.js.org/samples/palettes/rock-and-gravel)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-rock-and-gravel@3/tsparticles.palette.rock-and-gravel.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadRockAndGravelPalette(tsParticles);
