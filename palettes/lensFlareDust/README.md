...
# tsParticles Lens Flare Dust Palette
...
[tsParticles](https://github.com/tsparticles/tsparticles) palette for lens flare dust.
...
[![demo](https://raw.githubusercontent.com/tsparticles/palettes/main/palettes/lensFlareDust/images/sample.png)](https://particles.js.org/samples/palettes/lens-flare-dust)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-lens-flare-dust@3/tsparticles.palette.lens-flare-dust.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadLensFlareDustPalette(tsParticles);

  await tsParticles.load({
    id: "tsparticles",
    options: {
      palette: "lens-flare-dust",
    },
  });
})();
```
...
Checkout the documentation in the component library repository and call the `loadLensFlareDustPalette` function instead of `loadFull`, `loadSlim` or similar functions.
...
palensFlareDust[Lens Flare Dust]
end

e[tsParticles Engine] --> palensFlareDust
```
