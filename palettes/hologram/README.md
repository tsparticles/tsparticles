...
[![demo](https://raw.githubusercontent.com/tsparticles/presets/main/palettes/hologram/images/sample.png)](https://particles.js.org/samples/palettes/hologram)
...
```html
<script src="https://cdn.jsdelivr.net/npm/@tsparticles/palette-hologram@3/tsparticles.palette.hologram.bundle.min.js"></script>
```
...
```javascript
(async () => {
  await loadHologramPalette(tsParticles);
