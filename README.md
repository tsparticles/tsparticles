...
This preset loads white and red confetti launched from the centre of the screen on a transparent background.
...
If you have created some good designs with _tsParticles_ feel free to submit a pull request with your cool template, you'll be
...
Want to see ever more demos? Clone the repository on your computer and follow the below instructions:
...
tsParticles now supports some customizationstoo 🥳!
