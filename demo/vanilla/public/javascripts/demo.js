(async () => {
  ...
  let updateParticles = async editor => {
    let presetId = sessionStorage.presetId || "basic";
    ...
    sessionStorage.presetId = presetId;
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    ...
    cmbPresets.onchange = async () => {
      sessionStorage.presetId = cmbPresets.value;
    ...
    if (!sessionStorage.presetId) {
      sessionStorage.presetId = "basic";
    }

    cmbPresets.value = sessionStorage.presetId;
